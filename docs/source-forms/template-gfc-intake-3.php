    ...
    <div class="intake-page" id="page-priv">
      ...
      <div class="section">
        <div class="section-head">
          ...
          <h2>HIPAA Releases of Information</h2>
        </div>
        <div class="section-body">
          <div class="consent-block">
            <h3>Authorization to Share Information (Family &amp; Care Team)</h3>
          ...
          <!-- ROI-PROVIDER: inbound authorization to OBTAIN records -->
          <div class="consent-block" style="margin-top:24px;">
            <h3>Authorization to Obtain Medical Records</h3>
            <p>I authorize Godwins Family Care LLC to request and obtain my (or my loved one's) medical records and health information from the providers, practices, hospitals, and pharmacies listed below, for the purpose of treatment, care coordination, and care planning.</p>
            <p>This covers records such as the history and physical, problem and diagnosis list, medications, allergies, lab and imaging results, and discharge summaries. It expires one year from the date signed unless revoked sooner, and may be revoked in writing at any time.</p>
          </div>
          <div class="field" style="margin-top:12px;">
            <label>Current providers we may request records from</label>
            <p class="field-hint">List each provider or facility: name, practice or hospital, and a phone or fax number if known.</p>
            <textarea id="roiProviders" placeholder="e.g. Dr. Patricia Lee, Northside Family Medicine, 770-555-0100 (fax 770-555-0101); Piedmont Hospital Medical Records 404-555-0199…"></textarea>
          </div>
          <div class="sig-block" style="margin-top: 16px;">
            <input type="text" class="sig-input" id="sig-roiprov-typed" placeholder="Type your full name to sign" autocomplete="off">
            <label class="sig-ack">
              <input type="checkbox" id="sig-roiprov-ack">
              <span>By typing my name above and checking this box, I authorize Godwins Family Care LLC to obtain the medical records described above.</span>
            </label>
            <p class="sig-label">Client or Authorized Representative Signature, Authorization to Obtain Records</p>
          </div>
          <div class="grid-2" style="margin-top:12px;">
            <div class="field">
              <label>Date</label>
              <input type="date" id="sigROIProvDate">
            </div>
            <div class="field">
              <label>Printed Name</label>
              <input type="text" id="sigROIProvName" placeholder="Print full name">
            </div>
          </div>
        </div>
      </div>
...
<div class="section">
        ...
        <div class="section-body">
          <div class="consent-block">
            ...
            <p>Godwins Family Care LLC delivers care through two service lines. <strong>Private Home Care</strong> provides non-medical personal care and companionship, including assistance with activities of daily living and medication reminders, and, where ordered, skilled nursing delivered by licensed nurses under the oversight of our family nurse practitioner or supervising physician. <strong>In-Home Primary Care</strong> provides medical visits, assessment, prescribing, and chronic disease management led by a nurse practitioner.</p>
            <p>Personal care aides provide reminders and support and observe and report changes in condition. They do not administer medication or make clinical decisions. Skilled nursing and medical services are provided only by appropriately licensed clinicians and only as set out in your care plan.</p>
            <p>Your care plan is developed with you, your family, and your care team, and is reviewed periodically. Please report any change in condition or care needs promptly so the plan can be updated.</p>
          </div>
          <div class="sig-block" style="margin-top: 16px;">
...
alert('JS error: ' + err.message);
  ...
  function handleSubmit() {
    ...
    const data = {
      ...
      roiProviders: val('roiProviders'),
      sigROIProv: getSig('sig-roiprov'),
      sigROIProvName: val('sigROIProvName'), sigROIProvDate: val('sigROIProvDate')
    };
