...
| 4 | **Clinical / In-Home Primary Care portal + OpenEMR** | Clinical | 🟡 In progress — **4.1 clinician workspace ✅ Done (PR #19)**; **4.2 scheduling ✅ Done (PR #22)**; 4.3 patient clinical read ⬜ next |
...
## Rough timeline
- **Now (updated 2026-08-30):** Sessions 1–4.2 merged (4.1 PR #19, 4.2 PR #22). Next: build Session 4.3 (patient clinical read + POA gates + case-manager read), then Session 5 (clinical go-live: AWS boundary, auth migration, audit).
