...
| 4 | **Clinical / In-Home Primary Care portal + OpenEMR** | Clinical | 🟡 In progress — **4.1 clinician workspace ✅ Done (PR #19)**; **4.2 scheduling ✅ built · PR pending**; 4.3 patient clinical read ⬜ next |
