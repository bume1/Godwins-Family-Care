...
_Last updated: 2026-08-29 (Session 4.2 built · PR pending)_
...
| 4.2 | Clinician scheduling (OpenEMR-tied) | ✅ built · PR pending | — (pending) |
...
**08/2026 (late) — Session 4.2 built (branch `claude/clinician-scheduling-k6bd56`, PR pending).** Clinician scheduling, OpenEMR-tied, per the Session 4.2 prompt. Locked in:
...
**08/2026 — Session 4.1 built (branch `claude/clinician-care-plan-auth-ra1t7k`, merged as PR #19).** Clinician workspace + OpenEMR write per the Session 4.1 prompt. Locked in:
